...
text_3 = visual.TextStim(win=win, name='text_3',
    text=u"Le bloc de pratique est constitu\xe9 de 10 essais.\nVeuillez appuyer avec le pouce droit pour commencer le bloc de pratique.\nVous aurez \xe0 utiliser le pouce droit pour signaler \nla d\xe9tection d'un objet pour l'enti\xe8ret\xe9 de ce bloc, ",
    font=u'Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
...
n_objets = visual.RatingScale(win=win, name='n_objets', marker=u'triangle', size=1.0, pos=[0.0, 0.0], low=0, high=5, labels=[u'0', u' 5 et plus'], scale=u"Veuillez indiquer le nombre d'objets significatifs per\xe7us", disappear=True)
...
Redondance_question = visual.RatingScale(win=win, name='Redondance_question', marker=u'triangle',
                                        ...
                                        scale=u"Pour l'ensemble des 12 premiers blocs, veuillez indiquer \xe0 quel point vos perceptions \xe9taient diversifi\xe9es",
...
rating_sham = visual.RatingScale(win=win, name='rating_sham', marker=u'triangle', size=1.0, pos=[0.0, -0.4],
                                ...
                                scale=u'\xc0 quel point avez-vous per\xe7u une diff\xe9rence entre le dernier bloc et les blocs pr\xe9c\xe9dents ?',
                                disappear=True, respKeys = (), leftKeys = '5', rightKeys = '6', acceptKeys = ['4', '7'],
                                        markerStart = '5')
...
trials_1 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_01.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_02.xlsx'),
...
trials_3 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_03.xlsx'),
...
trials_4 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_04.xlsx'),
...
trials_5 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_05.xlsx'),
...
trials_6 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_06.xlsx'),
...
trials_7 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_07.xlsx'),
...
trials_8 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_08.xlsx'),
...
trials_9 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_09.xlsx'),
...
trials_10 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_10.xlsx'),
...
trials_11 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_11.xlsx'),
...
trials_12 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_12.xlsx'),
...
trials_sham_1 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_13.xlsx'),
...
trials_sham_2 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_14.xlsx'),
...
trials_sham_3 = data.TrialHandler(nReps=1, method='random',
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'Images_15.xlsx'),
